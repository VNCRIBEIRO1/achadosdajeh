...
import { ShieldCheck, BadgeDollarSign, Store, RefreshCw } from "lucide-react";
    ...
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 space-y-8 sm:space-y-12">
        ...
        <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { Icon: ShieldCheck, title: "Links Seguros", desc: "Direcionamos para lojas oficiais", color: "text-green-500" },
            { Icon: BadgeDollarSign, title: "Melhores Preços", desc: "Curadoria dos menores valores", color: "text-orange-500" },
            { Icon: Store, title: "Lojas Confiáveis", desc: "Shopee, Magalu e Mercado Livre", color: "text-blue-500" },
            { Icon: RefreshCw, title: "Atualizado", desc: "Novos achados todos os dias", color: "text-purple-500" },
          ].map((badge) => (
            <div
              key={badge.title}
              className="bg-white rounded-2xl p-4 sm:p-6 text-center shadow-sm border border-gray-100"
            >
              <badge.Icon className={`mx-auto ${badge.color}`} size={28} />
